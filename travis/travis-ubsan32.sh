...
export GOAL="install"
export BITCOIN_CONFIG="--enable-zmq --enable-glibc-back-compat --enable-reduce-exports LDFLAGS=-static-libstdc++ --enable-ubsan"
export USE_SHELL="/bin/dash"
#export CFLAGS="-fsanitize=undefined -O1 -fno-omit-frame-pointer"
